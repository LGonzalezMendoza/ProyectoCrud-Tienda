...
//el codigo para ordenar la seleccion de la tabla 
...
<body>
	<a href="index.php">Inicio</a> | <a href="añadir.html">Nueva Tienda</a> | <a href="cerrar_sesion.php">Cerrar Sesion</a>
	<br/><br/>
	...
	<table width='80%' border=0>
		...
		while($res = mysqli_fetch_array($result)) {		
			...
			echo "<td><a href=\"editar.php?id=$res[id]\">Editar</a> | <a href=\"eliminar.php?id=$res[id]\" onClick=\"return confirm('Realmente Quieres Borrar La Tienda?')\">Borrar</a></td>";		
		}
		?>
	</table>	
</body>
